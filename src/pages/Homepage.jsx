    ...
    return (
        <>
            ...
            <div className='bg-[#F5F1F1] flex flex-row items-center justify-center w-full min-h-screen h-11/12 gap-32 '>
                <div className='flex flex-col max-w-160 max-h-150 gap-4'>
                    <h2 className='text-6xl font-extrabold text-[#333] px-44'>Empower Learning.</h2>
                    <h2 className='text-6xl font-extrabold text-[#333] px-44'>Anytime, Anywhere.</h2>
                    ...
                    <div className='flex flex-row h-14 w-full gap-4 mt-3 px-4'>
                        <button  style={{padding: '12px 32px'}} className='mx-4 bg-[#333] text-white px-6 py-2 rounded text-2xl' onClick={() => setIsModalOpen(true)} >Start Learning</button>
                        <button  style={{padding: '12px 32px'}} className='border-2 border-[#333] rounded px-6 py-2 text-2xl'>Know more</button>
                    </div>
