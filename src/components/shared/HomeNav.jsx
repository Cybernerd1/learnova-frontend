...
const HomeNav = () => {
    ...
    return (
        <>
            <div className="flex flex-row items-center justify-between max-w-full w-full h-12 fixed py-8 px-28 top-0 bg-white text-[#333333] z-10">
                <div >
                ...
                <div>
                    ...
                    <button onClick={() => setIsModalOpen(true)} className="hover:cursor-pointer relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-[#333] transition duration-300 ease-out border-2 border-[#333] rounded-full shadow-md group text-0.5xl">
